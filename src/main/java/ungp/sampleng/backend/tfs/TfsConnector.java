...
public class TfsConnector
{
    ...
    public static void main(String[] args) {
		TFSTeamProjectCollection connection = TfsConnector.connectToTFS();
		WorkItemClient workItemClient = connection.getWorkItemClient();
		ProjectCollection projects = workItemClient.getProjects();
		for (Project project : projects) {
			NodeCollection areaRootNodes = project.getIterationRootNodes();
			System.out.println("projeto: " + project.getName() + " " + areaRootNodes.size());
		}
	}
